...
public class AuthService : IAuthService
{
    ...
    public async Task<(bool Success, bool IsNewUser, string Role, string Token, string email, string name, string reg_no)> VerifyOtpAsync(string phone, string otpCode)
    {
        ...
        return (true, isNewUser, user?.Role, token, user?.Email, user?.Name, user?.RegistrationNumber);
    }
