...
export default function AdminMaster({ children, title }: { children: React.ReactNode, title?: string }) {
    const [isOpen, setIsOpen] = useState(false);

    return (
        <>
            <Head>
                <title>{title || 'Welcome'} | Upkaran Admin</title>
            </Head>
            {/* <AdminNavbar />
            <AdminSidenav /> */}
            <div className="antialiased bg-gray-50 dark:bg-gray-900">
                <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
                    <div className="flex flex-wrap justify-between items-center">
                        <div className="flex justify-start items-center">
                            ...
                            <Link href="/mstcadmin/home" className="flex items-center justify-between mr-4">
                                <LogoOnly />
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white font-bakbak uppercase">Admin</span>
                            </Link>
                ...
                <AdminSidenav isOpen={isOpen} />
                <main className="p-4 pl-8 md:ml-64 min-h-screen pt-20">
