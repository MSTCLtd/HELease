            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card>
                    <div className="w-full bg-white rounded-lg dark:bg-gray-800 p-4 md:p-6">
                        ...
                        <Chart options={options} type='bar' series={options.series} />
                ...
                <Card>
                    <div className="w-full bg-white rounded-lg dark:bg-gray-800 md:p-6">
                        <div className="flex justify-between pb-4 mb-4">
                            <div className="flex items-center">
                                <div className="w-12 h-12 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                                    <svg className="w-6 h-6 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
                        ...
                        <Chart options={options} type='heatmap' series={options.series} />
                        <div className="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
                            <div className="flex justify-between items-center pt-5">
                                <button
                                    id="dropdownDefaultButton"
