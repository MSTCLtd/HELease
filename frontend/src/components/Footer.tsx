...
export default function Footer() {
    return (
        <footer className="bg-gray-50 dark:bg-gray-800">
            <div className="p-4 py-6 mx-auto max-w-screen-2xl md:p-8 lg:-10">
                <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
                    <div className="col-span-2">
                        <span className='text-sm text-gray-500'>An initiative by</span>
                        <a href="#" className="flex items-center gap-2 mb-2 text-2xl font-semibold text-gray-900 sm:mb-0 dark:text-white">
                            <Image src={mstclogo} height={50} width={50} alt='MSTC Logo' />
                            <div className="flex flex-col">
                                <span>MSTC Limited</span>
                                <span className='text-sm text-gray-500'>A Government of India Enterprise</span>
                            </div>
                        </a>
                        <p className="my-4 font-light text-gray-500 dark:text-gray-400">Upkaran is a first of its kind initiative by MSTC Limited (Category 1 PSU under Ministry of Steel) to connect Brands / Manufacturers/ Dealers and MSMEs fostering innovation and sustainability in the manufacturing and production ecosystem</p>
                ...
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© {new Date().getFullYear()} <a href="https://www.mstcindia.co.in" target='_blank' className="hover:underline">MSTC Limited</a></span>
            </div>
        </footer>
    )
}
