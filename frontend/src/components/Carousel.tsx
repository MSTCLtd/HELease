        ...
        <div id="default-carousel" className="relative w-full h-full" data-carousel="slide">
            <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <Image src="https://flowbite.s3.amazonaws.com/block-thumbnails/marketing/hero-dark.svg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="" width={500} height={100} />
                </div>
                {/* <div className="hidden duration-700 ease-in-out" data-carousel-item>
